...
import peppermintHotChocolatetwo from '../assets/peppermintHotChocolatetwo.jpg';
import saltedCaramelBrowniesone from '../assets/saltedCaramelBrowniesone.jpg';
import espressoDelightCupcakesone from '../assets/espressoDelightCupcakesone.jpg';
import eggnogCheesecaketwo from '../assets/eggnogCheesecaketwo.jpg';
...
const recipes = [
    {
        ...
        image: [ peppermintHotChocolatetwo ]
    },
    {
        ...
        image: [ saltedCaramelBrowniesone ]
    },
    {
        ...
        image: [ espressoDelightCupcakesone ]
    },
    {
    ...
    return (
        <div className="container-fluid">
            ...
            <div className="recipe-details">
                <h1>{name}</h1>
                <img src={image[0]} alt={name} className="recipe-image" />
                <h2>Ingredients:</h2>
                <ul>
